...
static void GetRegPaths( TSettingsComponent component, const wchar_t *&regPath, const wchar_t *&gpPath )
{
	switch (component)
	{
		...
		case COMPONENT_SHARED:
			regPath=L"Software\\IvoSoft\\ClassicShell";
			gpPath=L"Software\\Policies\\IvoSoft\\ClassicShell";
			break;
	}
}
...
/*
	...
	if (SUCCEEDED(SHGetPropertyStoreForWindow(m_hWnd,IID_IPropertyStore,(void**)&pStore)))
	{
		PROPVARIANT val;
		val.vt=VT_LPWSTR;
		val.pwszVal=L"ClassicShell.Settings.Dialog";
...
"\t\t<target prefix=\"classic_shell\" namespace=\"IvoSoft.Policies.ClassicShell\" />\r\n"
"\t</policyNamespaces>\r\n"
...
"\t</supportedOn>\r\n"
"\t<categories>\r\n"
"\t\t<category name=\"ClassicShell\" displayName=\"$(string.ClassicShellCat)\" explainText=\"$(string.ClassicShellCatHelp)\"/>\r\n";

static const char *g_AdmxText1csm=
"\t\t<target prefix=\"classic_start_menu\" namespace=\"IvoSoft.Policies.ClassicStartMenu\" />\r\n"
"\t\t<using prefix=\"classic_shell\" namespace=\"IvoSoft.Policies.ClassicShell\" />\r\n"
"\t</policyNamespaces>\r\n"
"\t<supersededAdm fileName=\"\" />\r\n"
"\t<resources minRequiredRevision=\"1.0\"/>\r\n"
"\t<supportedOn>\r\n"
...
"\t\t\t<parentCategory ref=\"classic_shell:ClassicShell\" />\r\n"
"\t\t</category>\r\n";
...
"\t\t\t<string id=\"ClassicShellCat\">%ClassicShellCat%</string>\r\n"
"\t\t\t<string id=\"ClassicShellCatHelp\">%ClassicShellCatHelp%</string>\r\n"
...
bool SaveAdmx( TSettingsComponent component, const char *admxFile, const char *admlFile, const char *docFile )
{
	...
	switch (component)
	{
		...
		case COMPONENT_IE:
			...
			break;
		case COMPONENT_SHARED:
			keyName="Software\\Policies\\IvoSoft\\ClassicShell";
			prefix="CS_";
			catName="ClassicShell";
