...
void CItemManager::LoadCacheFile( void )
{
	...
	wchar_t path[_MAX_PATH]=L"%LOCALAPPDATA%\\ClassicShell\\DataCache.db";
...
{
	CItemManager *pThis=(CItemManager*)param;
	wchar_t path[_MAX_PATH]=L"%LOCALAPPDATA%\\ClassicShell";
	DoEnvironmentSubst(path,_MAX_PATH);
	...
	{
		wchar_t path3[_MAX_PATH]=L"%LOCALAPPDATA%\\ClassicShell\\DataCache.txt";
	...
	CloseHandle(file);
	wchar_t path2[_MAX_PATH]=L"%LOCALAPPDATA%\\ClassicShell\\DataCache.db";
