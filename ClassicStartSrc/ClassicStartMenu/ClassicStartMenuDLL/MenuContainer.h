...
public:
	...
	DECLARE_WND_CLASS_EX(L"ClassicStart.CUserWindow",0,COLOR_MENU)
...
public:
	virtual ATL::CWndClassInfo &GetWndClassInfo( void )
	{
		...
		{
			{sizeof(WNDCLASSEX),CS_DROPSHADOW|CS_DBLCLKS,StartWindowProc,0,0,NULL,NULL,NULL,(HBRUSH)(COLOR_MENU+1),NULL,L"ClassicStart.CMenuContainer",NULL},
...
public:
	...
	~CMenuFader( void );
	DECLARE_WND_CLASS_EX(L"ClassicStart.CMenuFader",0,COLOR_MENU)
