...
<Settings component="StartMenu" version="4.3.1">
	...
	<ProgramsMenuDelay value="2750"/>
	<HideProgramsMetro value="1"/>
	<RecentPrograms value="None"/>
	<ShutdownCommand value="CommandShutdownBox"/>
	<HybridShutdown value="1"/>
	<SelectLastShutdown value="0"/>
	<ProgramsWidth value="45"/>
	<JumplistWidth value="45"/>
	<AutoStart value="1"/>
	<HighlightNew value="0"/>
	<HighlightNewApps value="0"/>
	<MenuDelay value="20"/>
	...
	<TaskbarOpacity value="5"/>
	<TaskbarColor value="12950895"/>
	...
	<MenuItems7>
		...
		<Line>Item14.Command=separator</Line>
		<Line>Item15.Command=control_panel</Line>
		<Line>Item15.Settings=TRACK_RECENT|NOEXPAND</Line>
		<Line>Item16.Command=defaults</Line>
		<Line>Item17.Command=network_connections</Line>
		<Line>Item18.Command=separator</Line>
		<Line>Item19.Command=apps</Line>
		...
		<Line>Item23.Command=help</Line>
		<Line>Item23.Settings=ITEM_DISABLED</Line>
		<Line>Item24.Command=run</Line>
		<Line>Item25.Command=windows_security</Line>
		<Line>Item25.Settings=ITEM_DISABLED</Line>
	</MenuItems7>
