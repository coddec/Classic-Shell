...
Copy.Subtitle = ‏‏در حال حاضر این پوشه حاوی پرونده‌ای به نام "%s" است.
Copy.SubtitleRO = ‏‏در حال حاضر این پوشه حاوی پرونده‌ای فقط خواندنی به نام "%s" است.
Copy.SubtitleSys = ‏‏در حال حاضر این پوشه حاوی پرونده‌ای سیستمی به نام "%s" است.
Copy.Prompt1 = آیا می‌خواهید پرونده‌ی موجود را جایگزین کنید
Copy.Prompt2 = با این یکی؟
Copy.Yes = &بله
Copy.No = &خیر
Copy.YesAll = بله برای &همه
Folder.Title = تأیید جایگزینی پوشه
Folder.Prompt = آیا هنوز می‌خواهید پوشه را کپی یا منتقل کنید؟
...
Toolbar.PreviewPane = چارچوب پیش‌نمایش
...
Copy.Prompt1 = Voulez-vous remplacer le fichier existant
Copy.Prompt2 = par celui-ci ?
Copy.Yes = &Oui
Copy.No = &Non
Copy.YesAll = &Tous
Folder.Title = Confirmation du remplacement du dossier
Folder.Prompt = Voulez-vous vraiment déplacer ou copier le dossier ?
...
Copy.MoveHere = &Presunúť sem
Copy.Title = Potvrdiť nahradenie súboru
Copy.Subtitle = Tento priečinok už obsahuje súbor s názvom %s.
Copy.SubtitleRO = Tento priečinok už obsahuje súbor iba na čítanie s názvom %s.
...
Copy.Yes = &Áno
Copy.No = &Nie
Copy.YesAll = Áno &všetkým
Folder.Title = Potvrdiť nahradenie priečinka
Folder.Prompt = Skutočne chcete presunúť alebo skopírovať tento priečinok?
...
Toolbar.Email = Odošle vybrané súbory e-mailom
Toolbar.Properties = Vlastnosti
...
Toolbar.CustomizeFolder = Upraviť priečinok
Toolbar.MapDrive = Pripojiť sieťovú jednotku
Toolbar.DisconnectDrive = Odpojiť sieťovú jednotku
Toolbar.NavigationPane = Navigačný panel
Toolbar.DetailsPane = Panel podrobností
Toolbar.PreviewPane = Panel náhľadu
Toolbar.CopyTo = Kopírovať do
Toolbar.MoveTo = Presunúť do
Toolbar.Deselect = Zrušiť výber
Toolbar.InvertSelection = Invertovať výber
Status.FreeSpace = %s (voľné miesto na disku: %s)
Status.Item = Položka: %s 
Status.Items = Položky: %s
Status.ItemSelected = Vybratá položka: %s
Status.ItemsSelected = Vybraté položky: %s
